...
public class Election extends Contract {
    ...
    public static List<CandicateInformationEventResponse> getCandicateInformationEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(CANDICATEINFORMATION_EVENT, transactionReceipt);
    ...
    public static List<VotedEventEventResponse> getVotedEventEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(VOTEDEVENT_EVENT, transactionReceipt);
