...
public class Web3jUtil extends Contract {
    ...
    @Deprecated
    protected Web3jUtil(String contractAddress, org.web3j.protocol.Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected Web3jUtil(String contractAddress, org.web3j.protocol.Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected Web3jUtil(String contractAddress, org.web3j.protocol.Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected Web3jUtil(String contractAddress, org.web3j.protocol.Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static Web3jUtil load(String contractAddress, org.web3j.protocol.Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new Web3jUtil(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Web3jUtil load(String contractAddress, org.web3j.protocol.Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Web3jUtil(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Web3jUtil load(String contractAddress, org.web3j.protocol.Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new Web3jUtil(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Web3jUtil load(String contractAddress, org.web3j.protocol.Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new Web3jUtil(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<Web3jUtil> deploy(org.web3j.protocol.Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(Web3jUtil.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    public static RemoteCall<Web3jUtil> deploy(org.web3j.protocol.Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(Web3jUtil.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<Web3jUtil> deploy(org.web3j.protocol.Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(Web3jUtil.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<Web3jUtil> deploy(org.web3j.protocol.Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(Web3jUtil.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
